...
export default function Error() {
  ...
  return (
    <div className='bg-black/80 m-auto justify-center items-center rounded py-8 max-w-96 shadow-2xl mt-24 hover:bg-[#c1630b] transition-all hover:translate-y-[-10px] duration-500'>
